import 'package:we_flutter/generated/json/base/json_convert_content.dart';
...
ArticleEntity $ArticleEntityFromJson(Map<String, dynamic> json) {
	...
	final List<ArticleDatas>? datas = jsonConvert.convertListNotNull<ArticleDatas>(json['datas']);
	if (datas != null) {
...
ArticleDatas $ArticleDatasFromJson(Map<String, dynamic> json) {
	...
	if (type != null) {
		articleDatas.type = type;
	}
	final int? userId = jsonConvert.convert<int>(json['userId']);
	if (userId != null) {
		articleDatas.userId = userId;
	}
	final int? visible = jsonConvert.convert<int>(json['visible']);
	if (visible != null) {
		articleDatas.visible = visible;
	}
	final int? zan = jsonConvert.convert<int>(json['zan']);
	if (zan != null) {
		articleDatas.zan = zan;
	}
	return articleDatas;
}

Map<String, dynamic> $ArticleDatasToJson(ArticleDatas entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
...
ArticleDatasTags $ArticleDatasTagsFromJson(Map<String, dynamic> json) {
	final ArticleDatasTags articleDatasTags = ArticleDatasTags();
	final String? name = jsonConvert.convert<String>(json['name']);
	if (name != null) {
		articleDatasTags.name = name;
	}
	final String? url = jsonConvert.convert<String>(json['url']);
	if (url != null) {
		articleDatasTags.url = url;
	}
	return articleDatasTags;
}

Map<String, dynamic> $ArticleDatasTagsToJson(ArticleDatasTags entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
