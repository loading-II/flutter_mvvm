...
class JsonConvert {
	static final Map<String, JsonConvertFunction> convertFuncMap = {
		...
		(ArticleDatas).toString(): ArticleDatas.fromJson,
		(ArticleDatasTags).toString(): ArticleDatasTags.fromJson,
  ...
  T? _asT<T extends Object?>(dynamic value,
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<ArticleDatas>[] is M){
			return data.map<ArticleDatas>((Map<String, dynamic> e) => ArticleDatas.fromJson(e)).toList() as M;
		}
		if(<ArticleDatasTags>[] is M){
			return data.map<ArticleDatasTags>((Map<String, dynamic> e) => ArticleDatasTags.fromJson(e)).toList() as M;
		}
